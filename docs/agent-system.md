...
> **快速导航：** [导语](#intro) · [原则](#principles) · [读前须知](#read-first) · [角色与职责](#registry) · [唯一真人模式](#human-mode) · [编排完整图](#orchestration-full) · [产品成熟度](#maturity) · [纯自动化链](#autochain) · [落地建议](#execution) · [附录](#appendix)
